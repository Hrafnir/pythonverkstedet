...
Appen legger automatisk dette i e-posten:

- type tilbakemelding
- område eller modul
- skole, hvis avsenderen oppgir det
- navn, hvis avsenderen oppgir det
- appversjon
- selve tilbakemeldingen

Det gjør det mulig å sortere tilbakemeldinger i for eksempel `feil`, `faglig innhold`, `brukervennlighet`, `nye ønsker` og `ros`, uten at appen lagrer personopplysninger eller sender noe i bakgrunnen.
