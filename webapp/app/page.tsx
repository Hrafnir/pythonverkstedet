        ...
        <div className={`studio-workspace ${hasTask?"with-lesson":""} ${helpOpen?"with-help":""} tab-${workspaceTab}`} style={{"--editor-share":`${editorShare}%`} as CSSProperties} ref={workbenchRef}>
          ...
          <div className="coding-area">
            <section className="editor-panel studio-editor" aria-label="Kodeflate">
              ...
              <PythonEditor id={editorId} value={pygameView?pygameCode:code} onChange={pygameView?updatePygameCode:updateCode} describedBy="studio-editor-help" fontSize={editorFontSize} errorLine={errorCoach?.lineNumber} onSelectionChange={(start,end,selected)=>setEditorSelection({start,end,selected})}/>
